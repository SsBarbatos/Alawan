...
public class FragmentAddAlerteInvite extends Fragment
{
    View view;
    TextView tvPicture;
    ...
    public FragmentAddAlerteInvite()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_add_alerte_invite, container, false);
